...
void load_all_sound(t_game *g)
{
	...
	g->sounds[1].effect = Mix_LoadWAV("gfx/scratch/bomb_timer.wav");
	g->sounds[2].effect = Mix_LoadWAV("gfx/scratch/confirm.wav");
	g->sounds[3].effect = Mix_LoadWAV("gfx/scratch/explose.wav");
	g->sounds[4].effect = Mix_LoadWAV("gfx/scratch/out.wav");
	g->sounds[5].effect = Mix_LoadWAV("gfx/scratch/pause.wav");
